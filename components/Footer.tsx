        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16">
          <div>
             <Link href="/" className="flex items-center gap-3 mb-8 group">
              <div className="w-10 h-10 bg-sunrise rounded-xl flex items-center justify-center rotate-3 group-hover:rotate-12 transition-transform">
            ...
            <p className="text-snow/50 text-lg leading-relaxed max-w-md mb-12">
            ...
            <div className="flex gap-6">
               <a href="#" className="w-12 h-12 rounded-full border border-snow/10 flex items-center justify-center hover:bg-sunrise hover:text-charcoal transition-all">
