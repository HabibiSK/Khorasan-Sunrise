                ...
                {isLogo ? (
                  ...
                  <>
                    ...
                    <motion.div
                      ...
                      style={{ position: 'absolute', left: 0, bottom: '-0.25rem', width: '100%', height: '2px', background: 'linear-gradient(to right, #FFD700, #FFD700)', transform: pathname === href ? 'scaleX(1)' : 'scaleX(0)', transformOrigin: 'left' }}
                    />
                  </>
                )}
              </Link>
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              style={{ background: 'rgba(255,255,255,0.15)', backdropFilter: 'blur(16px)', borderRadius: '1rem' }}
            >
